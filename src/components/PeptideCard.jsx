...
import { Check, Clock, AlertCircle, Zap, X, Pause, Play } from 'lucide-react'
    ...
    >
      {showDelete && (
        <button
          ...
          className="absolute top-3 right-3 z-10 p-1.5 bg-red-500/10 hover:bg-red-500/20 border border-red-500/30 rounded-lg transition-all hover:scale-110 group/delete"
        >
